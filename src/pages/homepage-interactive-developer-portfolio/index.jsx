        ...
        <div className="max-w-apple-lg mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://drive.google.com/drive/u/1/folders/1SdoRbrI4-a58DQPXN5V_ryLVdvofROgA" target="_blank" rel="noopener noreferrer" className="text-apple-gray-400 hover:text-white transition-colors duration-300">
